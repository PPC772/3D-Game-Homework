...
namespace Model{
    ...
    public class ShipModel{
        ...
        public void ShipMove(){
            if (ship_left){
                move.MovePosition(new Vector3 (3.5F, -3, 0));
                ship_left = false;
            }
            else{
                move.MovePosition(new Vector3 (-3.5F, -3, 0));
    ...
    public class RoleModel{
        ...
        public bool on_ship;   
        Move move;
        public LandModel land_model = (SSDirector.GetInstance().CurrentScenceController as Controller).right_land;
